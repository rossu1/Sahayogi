...
const styles = StyleSheet.create({
  ...
  backText: { color: colors.textPrimary, fontSize: fontSizes.md, fontWeight: '600' },
  headerTitle: { flex: 1, color: colors.textPrimary, fontSize: 15, fontWeight: '700', textAlign: 'center' },
  ...
  introTitle: { fontSize: fontSizes.lg, fontWeight: '800', color: colors.textPrimary },
  introSubtext: { fontSize: fontSizes.sm, color: colors.textSecondary, textAlign: 'center' },
  ...
  contactRel: { fontSize: 11, color: colors.textMuted, textTransform: 'capitalize' },
  removeBtn: {
    width: 32,
    height: 32,
    borderRadius: 16,
  ...
  formTitle: { fontSize: fontSizes.md, fontWeight: '800', color: colors.textPrimary },
  input: {
    borderWidth: 1.5,
  ...
  fieldLabel: { fontSize: 12, fontWeight: '700', color: colors.textSecondary, marginTop: spacing.xs },
  ...
  relChipActive: { borderColor: colors.emergencyRed, backgroundColor: 'rgba(220,38,38,0.15)' },
  relText: { fontSize: fontSizes.sm, color: colors.textSecondary, fontWeight: '600' },
  ...
  cancelBtnText: { fontSize: fontSizes.md, fontWeight: '700', color: colors.textPrimary },
  saveBtn: {
    flex: 1,
    paddingVertical: 14,
    borderRadius: borderRadius.md,
  ...
  addBtnIcon: { fontSize: 24, color: colors.textMuted, fontWeight: '700' },
  addBtnText: { fontSize: fontSizes.md, fontWeight: '700', color: colors.textMuted },

  maxText: { fontSize: fontSizes.sm, color: colors.textMuted, textAlign: 'center' },
});
