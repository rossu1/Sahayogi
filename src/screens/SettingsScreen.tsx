...
const styles = StyleSheet.create({
  ...
  rowLabel: { flex: 1, fontSize: fontSizes.sm, color: colors.textPrimary, marginRight: spacing.sm },
  ...
  langSelected: { borderColor: colors.emergencyRed, backgroundColor: 'rgba(220,38,38,0.15)' },
  langText: { fontSize: fontSizes.md, color: colors.textSecondary, fontWeight: '600' },
  langTextSelected: { color: colors.emergencyRed, fontWeight: '800' },

  qualDivider: { height: 1, backgroundColor: colors.borderSubtle, marginVertical: spacing.sm },
  qualLabel: { fontSize: 12, fontWeight: '700', color: colors.textSecondary, marginBottom: spacing.xs },
  ...
  qualSelected: { borderColor: colors.safeGreen, backgroundColor: 'rgba(22,163,74,0.15)' },
  ...
  phoneText: { fontSize: fontSizes.md, color: colors.textPrimary },
  aboutText: { fontSize: fontSizes.sm, color: colors.textSecondary, lineHeight: 22 },
  version: { fontSize: fontSizes.xs, color: colors.textMuted, marginTop: spacing.sm },
  signOutBtn: {
  ...
  emergencyBarText: { color: colors.textSecondary, textAlign: 'center', fontSize: fontSizes.xs },
});
